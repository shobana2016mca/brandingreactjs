        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-2 mx-auto md:grid-cols-2">
          <div className={`${isVisible ? "animate-fadeUp " : "  "} `} ref={ref}>
            ...
            <p className="mt-4 text-lg text-slate-700">
              “Branding Solutions has transformed our software company’s online
              presence. Their expertise in creating a cohesive and compelling
              brand identity has significantly increased our visibility and
              customer engagement. Their team is professional, creative, and
              truly understands our needs. We highly recommend their services to
              any business looking to enhance their brand.”
            </p>
          ...
          <div
            className={` max-w-[590px] h-auto mx-auto mt-4  flex items-center justify-center ${isVisible ? "animate-fadeUp " : "  "} `}
          >
            <img
              loading="lazy"
