...
function BlogPage() {
  ...
  const [blog, setBlog] = useState(() =>
    newsBlogs.filter((e) => e.id.toString() === id)
  );
  window.scrollTo(0, 0);
          ...
          <main className="w-full md:col-span-2">
            <article className="p-6 bg-white ">
              ...
              <div className="mt-2 text-gray-600">
                <span>{blog[0].author}</span> <span className="ml-2"> </span>{" "}
                <span>{blog[0].date}</span>
              </div>
              <p className="mt-4 text-gray-700">{blog[0].content}</p>
            </article>
          </main>
            ...
            <div className="p-6 bg-white shadow-md">
              <div className="pt-2 border-t-2 border-black ">
                ...
                <form className="flex">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 text-white bg-orange-500 "
                  >
