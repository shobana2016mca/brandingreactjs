    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            name="description"
            content="Learn about the wide range of services offered by My Awesome Company. We provide exceptional solutions to meet your needs."
          />
          <meta
            name="keywords"
...
Web Designing in Punjab"
          ...
          <meta
            property="og:title"
            content="Our Services - My Awesome Company"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="http://www.myawesomecompany.com/services"
          />
          <meta
            property="og:image"
            content="http://www.myawesomecompany.com/services-image.jpg"
          />
          ...
          <link
            rel="canonical"
            href="http://www.myawesomecompany.com/services"
          />
        </Helmet>
        <BreadCrumbComponent />
        <Services />
